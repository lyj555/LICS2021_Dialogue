...
class DialogueDataset(IterableDataset):
    ...
    def load_file(self, file_path):
        """
        读取ID化的文件，文件每一行代表一个样本，一个样本由三部分id构成，分别为token_ids, type_ids和pos_ids
        """
...
if __name__ == "__main__":
    ...
    train_data_path = './datasets/output/train.txt'
    # 初始化Dataset
    ...
    for inputs in train_dataloader:
        ...
        break
    # token_ids [batch_length, max_len]  不同于batch_size的大小
    # type_ids  [batch_length, max_len]
    # pos_ids   [batch_length, max_len]
    # mask      [batch_length, 1, 254, 254]
    # tgt_label [n]  该batch内所有的label的列表
    # tgt_pos   [n]  该batch内所有的label的idx列表
